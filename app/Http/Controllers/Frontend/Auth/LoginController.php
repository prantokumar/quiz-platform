...
class LoginController extends Controller
{
    ...
    public function userLogin(Request $request)
    {
        try {
            ...
            $validator = Validator::make($contactFormData, [
                'email_or_mobile' =>  'required',
                'password' =>  'required|min:6|max:20',
            ], [
                'email_or_mobile.required' => 'Oops! You may forgot to enter your email or mobile.',
                'password.required' => 'Oops! You may forgot to enter your password.',
            ]);
            if ($validator->fails()) {
                return redirect()->back()->with('error_message', $validator->getMessageBag()->first());
            } else {
